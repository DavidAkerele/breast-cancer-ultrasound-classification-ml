...
def build_dissertation_docx():
    ...
    h1_run = h1_p.add_run("Deep Convolutional Neural Networks and Contrast Limited Adaptive Histogram Equalization (CLAHE) for Automated Breast Cancer Ultrasound Classification\n\n\n\n\n")
    ...
    out_path = os.path.join(doc_dir, "Breast_Cancer_Ultrasound_Dissertation.docx")
    doc.save(out_path)
