...
def build_presentation():
    ...
    p_title.text = "Deep Learning & Contrast Enhancements for Automated Breast Cancer Ultrasound Classification"
    ...
    out_path = os.path.join(doc_dir, "Breast_Cancer_Ultrasound_Presentation.pptx")
    prs.save(out_path)
